...
/**
 * @file hw_uart.c
 * @brief Implementation of UART functions for all 5 channels.
 * @author SUNG
 * @date 2026-01-11
 */
...
{
  return HAL_UART_Transmit(huart, pData, len, 100);
}

/**
 * @brief 수신 시작 (Interrupt)
 */
HAL_StatusTypeDef HW_UART_Receive_IT(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t len)
{
  return HAL_UART_Receive_IT(huart, pData, len);
}
